          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-blue-600 to-cyan-600 p-2 rounded-xl transform group-hover:scale-110 transition-transform duration-300">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              {navLinks.map((link) => (
                ...
                >
                  ...
                  {isActive(link.to) && (
                    <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full"></span>
                  )}
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                <div className="relative p-2 rounded-full hover:bg-blue-50 transition-colors">
                  <ShoppingCartIcon className="h-6 w-6 text-gray-700 group-hover:text-blue-600 transition-colors" />
                  {getItemCount() > 0 && (
                    <span className="absolute -top-1 -right-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center animate-pulse shadow-lg">
                      {getItemCount()}
                    </span>
                  )}
                </div>
              ...
              {user ? (
                <div className="hidden md:flex items-center space-x-3">
                  <div className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-full border border-blue-100">
                    <div className="h-8 w-8 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-full flex items-center justify-center shadow-md">
                  ...
                  <Link 
                    to="/orders" 
                    className="flex items-center space-x-1 px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all border border-transparent hover:border-blue-200"
                  >
                ...
                <div className="hidden md:flex items-center space-x-2">
                  <Link 
                    to="/login" 
                    className="flex items-center space-x-2 px-5 py-2.5 bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50 rounded-full transition-all font-semibold shadow-sm hover:shadow-md"
                  >
                  ...
                  <Link 
                    to="/register" 
                    className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white hover:from-blue-700 hover:to-cyan-700 hover:shadow-lg hover:scale-105 rounded-full transition-all font-semibold shadow-md"
                  >
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-2 bg-white/95 backdrop-blur-lg border-t border-gray-100">
            ...
            <div className="pt-4 border-t border-gray-200">
              {user ? (
                <>
                  <div className="flex items-center space-x-3 px-4 py-3 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl mb-2">
                    <div className="h-10 w-10 bg-gradient-to-br from-primary-600 to-primary-800 rounded-full flex items-center justify-center">
                  ...
                  <Link
                    to="/orders"
                    className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-primary-50 rounded-xl transition-all"
                  >
                    <ClipboardDocumentListIcon className="h-5 w-5" />
                ...
                <div className="space-y-2">
                  <Link
                    to="/login"
                    className="flex items-center justify-center space-x-2 w-full px-4 py-3 border-2 border-primary-600 text-primary-600 hover:bg-primary-50 rounded-xl transition-all font-semibold"
                  >
                    <UserIcon className="h-5 w-5" />
                    <span>Ingresar</span>
                  </Link>
                  <Link
                    to="/register"
                    className="flex items-center justify-center space-x-2 w-full px-4 py-3 bg-gradient-to-r from-primary-600 to-primary-800 text-white hover:shadow-lg rounded-xl transition-all font-semibold"
                  >
                    <UserPlusIcon className="h-5 w-5" />
                    <span>Registrarse</span>
                  </Link>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="bg-gradient-to-br from-primary-600 to-primary-800 p-2.5 rounded-xl">
            ...
            <div>
              <h4 className="text-lg font-bold mb-6 flex items-center">
                <span className="w-1 h-6 bg-gradient-to-b from-primary-600 to-primary-800 rounded-full mr-3"></span>
                Enlaces Rápidos
              </h4>
              <ul className="space-y-3">
                <li>
                  <Link to="/" className="text-gray-400 hover:text-white transition-colors flex items-center group">
                    <span className="w-0 group-hover:w-2 h-0.5 bg-primary-600 mr-0 group-hover:mr-2 transition-all"></span>
                    Inicio
                  </Link>
                </li>
                <li>
